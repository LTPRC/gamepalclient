...
export const constants = {
    ...
    BLOCK_TYPE_SINK: 12,
    BLOCK_TYPE_CEILING: 13,
    BLOCK_TYPE_GROUND_DECORATION: 14,
    BLOCK_TYPE_WALL_DECORATION: 15,
    BLOCK_TYPE_CEILING_DECORATION: 16,
    BLOCK_TYPE_BLOCKED_GROUND: 17,
    BLOCK_TYPE_HOLLOW_WALL: 18,
    BLOCK_TYPE_BLOCKED_CEILING: 19,

    STRUCTURE_UNDERSIDE_TYPE_SQUARE: 1,
    STRUCTURE_UNDERSIDE_TYPE_ROUND: 2,
    PLAYER_RADIUS: 0.1,
