...
export const constants = {
  ...
  BODY_PART_HEAD: 1,
  BODY_PART_BACK_HAIR: 2,
  BODY_PART_NECK: 3,
  BODY_PART_TORSO: 4,
  BODY_PART_LEFT_ARM: 5,
  BODY_PART_RIGHT_ARM: 6,
  BODY_PART_BREAST: 7,
  BODY_PART_OUTFIT_DECORATION: 8,
  BODY_PART_ACCESSORIES: 9,
  BODY_PART_LEFT_LEG: 10,
  ...
  ITEM_NO_OUTFIT_NRA_1: 'o008',
  ITEM_NO_OUTFIT_NRA_2: 'o009',
  ITEM_NO_OUTFIT_NRA_3: 'o010',
  ITEM_NO_OUTFIT_NRA_4: 'o011',
  ITEM_NO_OUTFIT_NRA_5: 'o012',
  ITEM_NO_OUTFIT_NRA_6: 'o013',
  ITEM_NO_OUTFIT_NRA_7: 'o014',
  ITEM_NO_OUTFIT_IJA_1: 'o015',
  ITEM_NO_OUTFIT_IJA_2: 'o016',

  ITEM_NO_OUTFIT_HAT_FARMER: 'o101',
  ITEM_NO_OUTFIT_HAT_RANGER: 'o102',
  ITEM_NO_OUTFIT_HAT_WHITE: 'o103',
  ITEM_NO_OUTFIT_HAT_BOWLER: 'o104',
  ITEM_NO_OUTFIT_HAT_TOP: 'o105',
  ITEM_NO_OUTFIT_HAT_RED: 'o106',

  ITEM_NO_OUTFIT_CAP_NRA_1: 'o108',
  ITEM_NO_OUTFIT_CAP_NRA_2: 'o109',
  ITEM_NO_OUTFIT_CAP_NRA_3: 'o110',
  ITEM_NO_OUTFIT_CAP_NRA_4: 'o111',
  ITEM_NO_OUTFIT_CAP_NRA_5: 'o112',
  ITEM_NO_OUTFIT_CAP_NRA_6: 'o113',
  ITEM_NO_OUTFIT_CAP_NRA_7: 'o114',
  ITEM_NO_OUTFIT_CAP_IJA_1: 'o115',
  ITEM_NO_OUTFIT_CAP_IJA_2: 'o116',
  ...
  BLOCK_CODE_SHOOT_THROW_JUNK: 142,
  ...
  BLOCK_CODE_DROP_SHADOW: 138,
  BLOCK_CODE_BUBBLE: 139,
  BLOCK_CODE_SHOCK: 140,
  BLOCK_CODE_TEXT_DISPLAY: 141,
  BLOCK_CODE_TIMED_BOMB: 143,
  BLOCK_CODE_NO_RESOURCE: 1000,
  BLOCK_CODE_BLACK: 1001,
  BLOCK_CODE_WHITE: 1002,
  BLOCK_CODE_TRANSPARENT: 1003,
  BLOCK_CODE_BLACK_CEILING: 1004,
  ...
  BLOCK_CODE_HUMAN_REMAIN_DEFAULT: 3107,
  BLOCK_CODE_ANIMAL_REMAIN_DEFAULT: 3108,
  BLOCK_CODE_MINE_FLAG: 3109,
  BLOCK_CODE_MELEE_DEFAULT: 3110,
  BLOCK_CODE_SHOOT_DEFAULT: 3111,
  ...
  BLOCK_TYPE_HUMAN_REMAIN_CONTAINER: 38,
  BLOCK_TYPE_ANIMAL_REMAIN_CONTAINER: 39,
  BLOCK_TYPE_TEXT_DISPLAY: 40,
  BLOCK_TYPE_MELEE: 41,
  BLOCK_TYPE_SHOOT: 42,
  ...
  STRUCTURE_SHAPE_TYPE_RECTANGLE: 2,
  PLAYER_RADIUS: 0.1,
  ...
  SKILL_CODE_SHOOT_SPRAY: 28,
  SKILL_CODE_SHOOT_THROW_JUNK: 29,
  SKILL_CODE_BUILD: 32,
  SKILL_CODE_FISH: 34,
  ...
  FACE_COEFS_LENGTH: 14,
  GENDER_MALE: 1,
  GENDER_FEMALE: 2,

  FRAME_DEFAULT: 0,
  PERIOD_STATIC_DEFAULT: -1,
  PERIOD_DYNAMIC_DEFAULT: 25,
  FRAME_MAX_INFINITE_DEFAULT: -1,
  DROP_DISAPPEAR_THRESHOLD_IN_FRAME: 60 * 25,
  MOVEMENT_MODE_DEFAULT: 0,
  MOVEMENT_MODE_STAND_GROUND: 1,
  MOVEMENT_MODE_WALK: 2,

  MISSION_STATUS_INITIATED: 0,
  MISSION_STATUS_COMPLETED: 1
}
